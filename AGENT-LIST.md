...
| Agent ID | 中文名 | 描述 | 来源 |
|----------|--------|------|------|
| `jimeng-expert` | 即梦专家 | 即梦（Jimeng/Dreamina）AI 创作平台提示词设计专家，精通文生图、图生图、文生视频、图生视频等全场景提示词体系，擅长将用户创意转化为即梦平台提示词 | 原创 |
| `xyq-expert` | 小云雀专家 | 小云雀（XiaoYunQue）AI 创作平台提示词与 API 消息设计专家，精通分镜设计、脚本创作、提示词优化等场景，擅长通过 Agent Skill 调用小云雀完成创作 | 原创 |
...
| 部门 | 数量 | 占比 |
|------|------|------|
| 专项部 (Specialized) | 47 | 22.1% |
| 营销部 (Marketing) | 35 | 16.4% |
| 工程部 (Engineering) | 33 | 15.5% |
